          ...
          <List>
            <ListItem>
              <Box className={classes.fullWidth}>
                ...
                <Select fullWidth value={category} onChange={categoryChange}>
            ...
            <ListItem>
              <Box className={classes.fullWidth}>
                ...
                <Select value={brand} onChange={brandChange} fullWidth>
                  <MenuItem value='all'>All</MenuItem>
                  {brands &&
                    brands.map((brand) => (
            ...
            <ListItem>
              <Box className={classes.fullWidth}>
                ...
                <Select value={price} onChange={priceChange} fullWidth>
                  <MenuItem value='all'>All</MenuItem>
                  {prices.map((price) => (
            ...
            <ListItem>
              <Box className={classes.fullWidth}>
                ...
                <Select value={rating} onChange={ratingChange} fullWidth>
                  <MenuItem value='all'>All</MenuItem>
                  {ratings.map((rating) => (
        ...
        <Grid item md={9}>
          <Grid container justifyContent='space-between' alignItems='center'>
            ...
            <Grid item>
              ...
              <Select value={sort} onChange={sortChange}>
